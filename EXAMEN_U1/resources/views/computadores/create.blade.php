        ...
        <form action="{{ route('computadores.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="codigo_tienda" class="w-full border rounded px-3 py-2" required>
                </div>

                <div>
                    <label class="block text-gray-700 font-bold mb-2">Procesador</label>
                    <input type="text" name="procesador" class="w-full border rounded px-3 py-2" required>
                </div>

                <div>
                    <label class="block text-gray-700 font-bold mb-2">RAM</label>
                    <input type="text" name="RAM" class="w-full border rounded px-3 py-2" required>
                </div>

                <div>
                    <label class="block text-gray-700 font-bold mb-2">Almacenamiento</label>
                    <input type="text" name="almacenamiento" class="w-full border rounded px-3 py-2" required>
                </div>

                <div>
                    <label class="block text-gray-700 font-bold mb-2">Tarjeta Gráfica</label>
                    <input type="text" name="tarjeta_grafica" class="w-full border rounded px-3 py-2" required>
                </div>
